...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('ur_here', $_LANG['affiliate_agent']);
    $smarty->assign('config', $config);
    $smarty->display('affiliate_agent.htm');
}
...
function get_affiliate_agent()
{
    $config = unserialize($GLOBALS['_CFG']['affiliate_agent']);
