...
<div class="main-div">
<form method="post" action="agent.php" name="theForm" onsubmit="return validate()">
<table width="100%" >
  <tr>
...
?>
  ...
  <tr>
	...
	<select name="parent_id">
		<option value="0"><?php echo $this->_var['lang']['none']; ?></option>
		<?php echo $this->html_options(array('options'=>$this->_var['agents'],'selected'=>$this->_var['user']['parent_id'])); ?>
	</select>
	</td>
  </tr>
  ...
  <tr>
    ...
    <td>[<a href="agent.php?act=aff_list&auid=<?php echo $this->_var['user']['user_id']; ?>"><?php echo $this->_var['lang']['show_affiliate_users']; ?></a>][<a href="affiliate_ck.php?act=list&auid=<?php echo $this->_var['user']['user_id']; ?>"><?php echo $this->_var['lang']['show_affiliate_orders']; ?></a>]</td>
  </tr>
  <tr>
    <td></td>
    <td>   
