...
?>
      ...
      <td class="first-cell" align="left">
       ...
       <?php endif; ?>
       <a href="javascript:listTable.remove(<?php echo $this->_var['list']['region_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>', 'drop_area')" title="<?php echo $this->_var['lang']['drop']; ?>"><?php echo $this->_var['lang']['drop']; ?></a>
       </span>
      </td>
