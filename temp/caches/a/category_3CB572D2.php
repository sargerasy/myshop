...
<title>索爱_手机配件_ECSHOP演示站 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">手机配件</a> <code>&gt;</code> 索爱 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
<div class="blank5"></div>
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=6&display=grid&brand=7&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/default/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=6&display=grid&brand=7&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=6&display=grid&brand=7&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
