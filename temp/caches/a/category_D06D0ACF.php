...
<div class="blank5"></div>
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=5&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/default/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=5&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=5&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
  ...
  <input type="hidden" name="order" value="DESC" />
    ...
    <li class="goodsName">
    <a href="goods.php?id=23" class="f6 f5">
                诺基亚N96<br />
              </a>
         </li>
    <li>
        市场价格：<font class="market">￥4440元</font><br />
            本店售价：<font class="shop">￥3700元</font><br />
        </li>
    <li class="action">
    <a href="javascript:collect(23);" class="abg f6">收藏该商品</a>
    <a href="javascript:addToCart(23)"><img src="themes/default/images/bnt_buy_1.gif"></a>
    </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    ...
    <li class="goodsName">
    <a href="goods.php?id=8" class="f6 f5">
                飞利浦9@9v<br />
              </a>
         </li>
    <li>
        市场价格：<font class="market">￥479元</font><br />
            本店售价：<font class="shop">￥399元</font><br />
        </li>
    <li class="action">
    <a href="javascript:collect(8);" class="abg f6">收藏该商品</a>
    <a href="javascript:addToCart(8)"><img src="themes/default/images/bnt_buy_1.gif"></a>
    </li>
    </ul>
        </div>
        </form>
