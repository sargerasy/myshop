...
<div class="blank5"></div>
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=6&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/default/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=6&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=6&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
  ...
  <input type="hidden" name="order" value="DESC" />
    ...
    <a href="javascript:;" id="compareLink" onClick="Compare.add(7,'诺基亚N85原装立体声耳机HS-82','2')" class="f6">比较</a>
    </li>
    <li class="goodsName">
    <a href="goods.php?id=7" class="f6 f5">
                诺基亚N85原装立体声耳机HS-82<br />
              </a>
         </li>
    <li>
        市场价格：<font class="market">￥120元</font><br />
            本店售价：<font class="shop">￥100元</font><br />
        </li>
    <li class="action">
    <a href="javascript:collect(7);" class="abg f6">收藏该商品</a>
    <a href="javascript:addToCart(7)"><img src="themes/default/images/bnt_buy_1.gif"></a>
    </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(5,'索爱原装M2卡读卡器','2')" class="f6">比较</a>
    </li>
    <li class="goodsName">
    <a href="goods.php?id=5" class="f6 f5">
                索爱原装M2卡读卡器<br />
              </a>
         </li>
    <li>
        市场价格：<font class="market">￥24元</font><br />
            本店售价：<font class="shop">￥20元</font><br />
        </li>
    <li class="action">
    <a href="javascript:collect(5);" class="abg f6">收藏该商品</a>
    <a href="javascript:addToCart(5)"><img src="themes/default/images/bnt_buy_1.gif"></a>
    </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(3,'诺基亚原装5800耳机','6')" class="f6">比较</a>
    </li>
    <li class="goodsName">
    <a href="goods.php?id=3" class="f6 f5">
                诺基亚原装5800耳机<br />
              </a>
         </li>
    <li>
        市场价格：<font class="market">￥82元</font><br />
            本店售价：<font class="shop">￥68元</font><br />
        </li>
    <li class="action">
    <a href="javascript:collect(3);" class="abg f6">收藏该商品</a>
    <a href="javascript:addToCart(3)"><img src="themes/default/images/bnt_buy_1.gif"></a>
    </li>
    </ul>
        </div>
        </form>
